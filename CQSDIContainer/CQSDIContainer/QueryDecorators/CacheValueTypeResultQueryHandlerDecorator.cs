...
{
	public class CacheValueTypeResultQueryHandlerDecorator<TQuery, TResult> : IDecorateQueryHandler<TQuery, TResult>
		...
		where TResult : struct
	{
		...
		public CacheValueTypeResultQueryHandlerDecorator(
		...
		public TResult Handle(TQuery query)
		{
			...
			return (TResult)_cache.Get(cacheKey, typeof(TResult), () => _queryHandler.Handle(query), _cacheKeyBuilder.TimeToLive);
		}
	}
}
