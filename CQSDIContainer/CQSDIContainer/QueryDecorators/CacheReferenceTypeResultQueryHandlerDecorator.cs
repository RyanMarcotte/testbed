...
{
	public class CacheReferenceTypeResultQueryHandlerDecorator<TQuery, TResult> : IDecorateQueryHandler<TQuery, TResult>
		...
		where TResult : class
	{
		...
		public CacheReferenceTypeResultQueryHandlerDecorator(
